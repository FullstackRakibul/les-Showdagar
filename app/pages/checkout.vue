      ...
      <div class="lg:col-span-2 space-y-8">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                >
                <input
                  v-model="checkoutStore.shippingInfo.name"
                  type="text"
                  required
              ...
              <div>
                ...
                >
                <input
                  v-model="checkoutStore.shippingInfo.phone"
                  type="tel"
                  required
                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div class="md:col-span-3">
                ...
                >
                <input
                  v-model="checkoutStore.shippingInfo.street"
                  type="text"
                  required
                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              ...
              <div>
                ...
                >
                <input
                  v-model="checkoutStore.shippingInfo.thana"
                  type="text"
                  required
                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              ...
              <div>
                <label
                  class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"
                  >Zillah (District)</label
                >
                <input
                  v-model="checkoutStore.shippingInfo.zillah"
                  type="text"
                  required
                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              ...
              <div>
                ...
                >
                <input
                  v-model="checkoutStore.shippingInfo.note"
                  type="text"
                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
        ...
        >
          ...
          <div class="space-y-6">
            ...
            <div>
              <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <label class="relative cursor-pointer">
                  <input
                    v-model="checkoutStore.paymentInfo.method"
                    type="radio"
                    value="cash"
                    class="sr-only"
                  />
                  <div
                    class="border-2 rounded-xl p-6 text-center transition-all duration-200"
                    :class="
            ...
            <!-- Credit Card Form -->
            <div
              v-if="checkoutStore.paymentInfo.method === 'card' && false"
              class="space-y-6"
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center space-x-1 mt-1">
                  <span
                    ...
                    class="text-xs bg-white dark:bg-gray-600 px-2 py-1 rounded"
