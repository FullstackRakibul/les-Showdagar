    ...
    <div class="px-4 sm:px-6">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center space-x-3">
          ...
          >
            ...
            <div class="hidden sm:flex flex-col">
              <span
                class="font-bold text-start text-gray-900 dark:text-white text-lg leading-tight"
                >SenderBD</span
              >
        ...
        <div class="flex items-center space-x-2">
          ...
          >
            ...
            <span
              v-if="productStore.cartItemsCount > 0"
      ...
      <transition name="slide-down">
        <div
          ...
          class="md:hidden pb-4 border-t border-gray-200 dark:border-gray-700 mt-4 pt-4"
        >
          <div class="relative">
            <Search
              class="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"
                  ...
                  >
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="flex items-center space-x-2 mt-2">
                        ...
                        <span
                          class="font-medium text-gray-900 dark:text-white min-w-[2rem] text-center"
                          >{{ item.quantity }}</span
                        >
                        <button
                          @click="
              ...
              >
                <div class="flex justify-between items-center mb-4">
                  ...
                  <span class="text-xl font-bold text-gray-900 dark:text-white"
                    >${{ productStore.cartTotal.toFixed(2) }}</span
                  >
                </div>
                <button
                  @click="
