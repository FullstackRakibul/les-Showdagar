<template>
  <teleport to="body">
    <transition name="modal">
      <div
        v-if="productStore.showProductModal && productStore.selectedProduct"
              ...
              <div class="lg:w-1/2 p-8 lg:py-12">
                ...
                <div class="flex items-center mb-8">
                  ...
                  <span
                    ...
                    >Save ${{ (product.originalPrice - product.price).toFixed(2) }}</span
                  >
                </div>
                ...
                <div v-if="product.sizes && product.sizes.length > 0" class="mb-6">
                  ...
                  <div class="flex flex-wrap gap-3">
                    <button
                      ...
                      class="px-4 py-2 border-2 rounded-lg transition-all duration-200 font-medium"
                      :class="{
                ...
                <div class="mb-8">
                  <span
                    ...
                    class="inline-flex items-center text-green-600 font-semibold text-lg"
                  >
                    <CheckCircle class="w-5 h-5 mr-2" /> In Stock
                  </span>
                  <span
                    v-else
                    class="inline-flex items-center text-red-600 font-semibold text-lg"
                  >
                    <XCircle class="w-5 h-5 mr-2" /> Out of Stock
                  </span>
                </div>
...
import { X, Star, CheckCircle, XCircle, ShoppingCart, Heart } from "lucide-vue-next";
...
// Reinitialize selections whenever a new product is opened
...
watch(() => productStore.selectedProduct, initializeSelections, { immediate: true });
</script>
