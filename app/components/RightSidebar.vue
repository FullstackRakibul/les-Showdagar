  ...
  <aside
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div class="p-4 sm:p-6 space-y-4">
        <!-- Flash Sale Banner -->
        <div class="bg-gradient-to-r from-red-500 to-pink-500 rounded-2xl p-6 text-white relative overflow-hidden">
          <div
          ...
          <div class="relative z-10">
            <div class="flex items-center mb-2">
              ...
              <span class="text-sm font-semibold uppercase tracking-wide">Flash Sale</span>
            </div>
        ...
        <div class="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-6 text-white">
          <div class="flex items-center mb-2">
            ...
            <span class="text-sm font-semibold uppercase tracking-wide">Free Shipping</span>
          </div>
        ...
        <div class="space-y-3">
          <div v-for="deal in hotDeals" :key="deal.id"
            ...
            <div class="flex items-center space-x-3">
              <img :src="deal.image" :alt="deal.name" class="w-12 h-12 object-cover rounded-lg" />
...
import {
  X, Flame, Star, Sparkles, TrendingUp, Mail, Zap, Truck, Gift, ShoppingCart
